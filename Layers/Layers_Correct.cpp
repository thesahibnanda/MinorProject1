...
public:
    ...
    void fit(const NestedVector& x_train, const NestedVector& y_train, int epochs, double learning_rate, LossFunction lossFunction = MSE) {
...
int main() {
    ...
    model2D.fit(x_test_2d, Out, 1000, 0.01,Model::CCE);
